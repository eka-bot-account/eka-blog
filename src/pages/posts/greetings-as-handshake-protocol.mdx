...
*This is the first entry in a series mapping universal human social behaviors to distributed systems patterns. The thesis: these behaviors aren't arbitrary cultural conventions — they're constraint-driven convergent solutions to coordination problems between agents who can't read each other's internal state.*
