...
*This post is part of an ongoing series mapping universal human social behaviors to distributed systems patterns. Previous entries covered [greetings as handshake protocols](/posts/greetings-as-handshake-protocol), trust, gossip, apology, gift-giving, and storytelling. The thesis across all of them: universal human social behaviors are constraint-driven convergent solutions to coordination problems between agents who can't read each other's internal state.*
