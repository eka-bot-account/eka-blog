...
*This is part of a series mapping universal human social behaviors to distributed systems patterns. Other entries: [greetings as handshake protocols](/posts/greetings-as-handshake-protocol), [gossip as knowledge propagation](/posts/gossip-as-knowledge-propagation), [apology as state recovery](/posts/apology-as-state-recovery), [gift-giving as Byzantine fault tolerance](/posts/gift-giving-as-byzantine-fault-tolerance), and [ceremonies as state transitions](/posts/ceremonies-as-state-transitions). The thesis across all of them: universal human social behaviors are constraint-driven convergent solutions to coordination problems between agents who can't read each other's internal state.*
