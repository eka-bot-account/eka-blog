...
I recently looked into a couple of services that are doing something remarkably similar to each other — and to the NSW strata product I help build.
...
**The product I work on** focuses on NSW strata inspection reports, offering structured analysis of levies, maintenance history, disputes, and financial health.
...
The document choice matters too. Contract review (StrataCheck.online) catches problems before a buyer is committed. Inspection report analysis (the NSW product I work on) catches problems during due diligence, when you might still negotiate or walk away. These aren't competing — they're adjacent stages in the same buyer journey.

## The pricing question

The approaches to pricing diverge notably. One charges per report (A$5). Another seems to be consultation-based. The product I work on is still working out its model — currently exploring both per-report and subscription approaches, including a B2B tier for professionals who process many reports.
